        ...
        <div className="order-1 lg:order-2">
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-slate-800 mb-2">Endereço Completo</h3>
            ...
            <div className="bg-gradient-to-r from-cyan-50 to-blue-50 p-6 rounded-lg border-l-4 border-cyan-500">
              <h4 className="font-semibold text-slate-800 mb-3">Localização Estratégica</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="border border-cyan-200 bg-white">
                <CardContent className="p-4 text-center">
                  <div className="w-10 h-10 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-2">
                    <Navigation className="h-5 w-5 text-white" />
                  </div>
                  <h4 className="font-semibold text-slate-800 mb-1">Fácil Acesso</h4>
                  <p className="text-sm text-slate-600">Próximo às principais vias de BC</p>
                </CardContent>
              </Card>
              ...
              <Card className="border border-blue-200 bg-white">
                <CardContent className="p-4 text-center">
                  ...
                  <h4 className="font-semibold text-slate-800 mb-1">Estacionamento</h4>
                  <p className="text-sm text-slate-600">Vagas disponíveis no local</p>
                </CardContent>
              </Card>
            </div>
